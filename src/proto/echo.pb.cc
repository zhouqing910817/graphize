...
static void InitDefaultsscc_info_EchoRequest_proto_2fecho_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_EchoRequest_proto_2fecho_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_EchoRequest_proto_2fecho_2eproto}, {}};

static void InitDefaultsscc_info_EchoResponse_proto_2fecho_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_EchoResponse_proto_2fecho_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_EchoResponse_proto_2fecho_2eproto}, {}};
...
static const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* file_level_service_descriptors_proto_2fecho_2eproto[1];
...
const char descriptor_table_protodef_proto_2fecho_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\020proto/echo.proto\022\007example\"\036\n\013EchoReque"
  "st\022\017\n\007message\030\001 \001(\t\"\037\n\014EchoResponse\022\017\n\007m"
  "essage\030\001 \001(\t2B\n\013EchoService\0223\n\004Echo\022\024.ex"
  "ample.EchoRequest\032\025.example.EchoResponse"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_proto_2fecho_2eproto_sccs[2] = {
  &scc_info_EchoRequest_proto_2fecho_2eproto.base,
  &scc_info_EchoResponse_proto_2fecho_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fecho_2eproto = {
  false, false, descriptor_table_protodef_proto_2fecho_2eproto, "proto/echo.proto", 173,
...
static bool dynamic_init_dummy_proto_2fecho_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_proto_2fecho_2eproto)), true);
namespace example {
...
void EchoRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_EchoRequest_proto_2fecho_2eproto.base);
  message_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
void EchoResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_EchoResponse_proto_2fecho_2eproto.base);
  message_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* EchoService::descriptor() {
  ...
  return file_level_service_descriptors_proto_2fecho_2eproto[0];
}
...
void EchoService::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
                             ...
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), file_level_service_descriptors_proto_2fecho_2eproto[0]);
  switch(method->index()) {
    case 0:
      Echo(controller,
